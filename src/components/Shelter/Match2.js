...
const Match = (props) => {
            ...
            return stores.map((store) => {
                if (store.name == Object.keys(distance_to_store)[0]) {
                    ...
                    return (
                        ...
                        <Grid item xs = {7.5}>
                            <div className="store_information" style = {{margin : '2% 0', width : '100%'}}>
                            <div className="store_picture">
                            <img width="100%" height="300" src={store.image}></img>
                            </div>
                            <h2 className="store_title">{store.name}</h2>
                            <h3 className = "store_title">Distance : <span style ={{fontWeight: 'bold'}}>{convertToMiles(distance_to_store[Object.keys(distance_to_store)[0]])} miles</span></h3>
                        ...
                        <Grid item xs = {4.5}>
                            ...
                            <MapContainer height = '600px' shelterName = {userDetails.name} storeName = {store.name} latlng1 = {{'latitude' : userDetails.latitude, 'longitude' : userDetails.longitude}} latlng2 = {{'latitude': store.latitude, 'longitude' : store.longitude}}/>
    ...
    return (
        <div className = "hero">
            ...
            <h2 className = "section-title" style = {{textAlign : 'center', marginBottom: '2%'}}>Here is a list of the best matches according to your location:</h2>
